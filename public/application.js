...
var tileSelect = function tileSelect() {
  var gameInfo = {
    turn: 0
  };

  var turnReset = function turnReset() {
  ...
  var checkWinner = function checkWinner() {
    ...
    $('.game-piece').click(function (event) {
      var sq0 = $('#tile-zero').html();
      var sq1 = $('#tile-one').html();
      var sq2 = $('#tile-two').html();
      var sq3 = $('#tile-three').html();
      var sq4 = $('#tile-four').html();
      var sq5 = $('#tile-five').html();
      var sq6 = $('#tile-six').html();
      var sq7 = $('#tile-seven').html();
      var sq8 = $('#tile-eight').html();
...
var onUpdateGame = function onUpdateGame(event) {
  api.updateGame(store.currentGameState).then(ui.updateGameSuccess).catch(ui.updateGameFailure);
};
